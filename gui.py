...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ansJudgeFrame = QtWidgets.QFrame(self.centralwidget)
        self.ansJudgeFrame.setGeometry(QtCore.QRect(250, 450, 641, 171))
        self.ansJudgeFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.ansJudgeFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.ansJudgeFrame.setObjectName("ansJudgeFrame")
        self.falseButton = QtWidgets.QRadioButton(self.ansJudgeFrame)
        self.falseButton.setGeometry(QtCore.QRect(150, 60, 131, 91))
        self.falseButton.setObjectName("falseButton")
        self.trueButton = QtWidgets.QRadioButton(self.ansJudgeFrame)
        self.trueButton.setGeometry(QtCore.QRect(10, 60, 131, 91))
        self.trueButton.setObjectName("trueButton")
        self.answerBlock = QtWidgets.QLabel(self.ansJudgeFrame)
        ...
        self.choiceQuestion.setGeometry(QtCore.QRect(1000, 20, 641, 171))
        ...
        self.answerQuestion.setGeometry(QtCore.QRect(1470, 20, 641, 171))
        ...
        self.questionList.currentRowChanged['int'].connect(self.ansJudgeFrame.hide)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.questionList.item(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.questionList.item(2)
        item.setText(_translate("MainWindow", "3"))
        item = self.questionList.item(3)
        item.setText(_translate("MainWindow", "4"))
        item = self.questionList.item(4)
        item.setText(_translate("MainWindow", "5"))
        item = self.questionList.item(5)
        item.setText(_translate("MainWindow", "6"))
        item = self.questionList.item(6)
        item.setText(_translate("MainWindow", "7"))
        item = self.questionList.item(7)
        item.setText(_translate("MainWindow", "8"))
        item = self.questionList.item(8)
        item.setText(_translate("MainWindow", "9"))
        item = self.questionList.item(9)
        item.setText(_translate("MainWindow", "10"))
        item = self.questionList.item(10)
        item.setText(_translate("MainWindow", "11"))
        item = self.questionList.item(11)
        item.setText(_translate("MainWindow", "12"))
        item = self.questionList.item(12)
        item.setText(_translate("MainWindow", "13"))
        item = self.questionList.item(13)
        item.setText(_translate("MainWindow", "14"))
        item = self.questionList.item(14)
        item.setText(_translate("MainWindow", "15"))
        item = self.questionList.item(15)
        item.setText(_translate("MainWindow", "16"))
        item = self.questionList.item(16)
        item.setText(_translate("MainWindow", "17"))
        item = self.questionList.item(17)
        item.setText(_translate("MainWindow", "18"))
        item = self.questionList.item(18)
        item.setText(_translate("MainWindow", "19"))
        item = self.questionList.item(19)
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.userNameLine.setGeometry(QtCore.QRect(170, 100, 311, 31))
        self.userNameLine.setObjectName("userNameLine")
        self.usernameLabel = QtWidgets.QLabel(Dialog)
        self.usernameLabel.setGeometry(QtCore.QRect(70, 90, 81, 41))
        self.usernameLabel.setObjectName("usernameLabel")
        self.passwordLabel = QtWidgets.QLabel(Dialog)
        self.passwordLabel.setGeometry(QtCore.QRect(70, 160, 81, 41))
        self.passwordLabel.setObjectName("passwordLabel")
        self.passwordLine = QtWidgets.QLineEdit(Dialog)
        self.passwordLine.setGeometry(QtCore.QRect(170, 170, 311, 31))
        self.passwordLine.setObjectName("passwordLine")
        self.frame = QtWidgets.QFrame(Dialog)
        self.frame.setGeometry(QtCore.QRect(50, 240, 461, 101))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.forgot_passwordButton = QtWidgets.QPushButton(self.frame)
        self.forgot_passwordButton.setGeometry(QtCore.QRect(10, 30, 141, 41))
        self.forgot_passwordButton.setObjectName("forgot_passwordButton")
        self.exitButton = QtWidgets.QPushButton(self.frame)
        self.exitButton.setGeometry(QtCore.QRect(200, 30, 111, 41))
        self.exitButton.setObjectName("exitButton")
        self.exitButton_2 = QtWidgets.QPushButton(self.frame)
        self.exitButton_2.setGeometry(QtCore.QRect(330, 30, 121, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.forgot_passwordButton.setText(_translate("Dialog", "forgot_password?"))
        self.exitButton.setText(_translate("Dialog", "enter"))
        self.exitButton_2.setText(_translate("Dialog", "exit"))